...
void __forceinline AngleNormalize ( float& angle )
{
...
float __forceinline FastRSqrt ( float number )
{
	union
	{
		float f;
...
Vector3 QAngle::ToVectors ( Vector3* side /*= nullptr*/, Vector3* up /*= nullptr*/ )
{
...
Vector3 QAngle::ToVectorsTranspose ( Vector3* side /*= nullptr*/, Vector3* up /*= nullptr*/ )
{
