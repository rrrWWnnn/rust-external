...
public:
	...
	virtual bool IsInBox ( Vector2 box_pos, Vector2 box_size );
...
bool Win32InputSys::Initialize ( IDirect3DDevice9* pDevice )
{
	...
	{
		//Win32::Error ( _ ( "GetCreationParameters failed" ) );
		return false;
	}
	...
	if ( !m_ulOldWndProc )
	{
		//Win32::Error ( _ ( "SetWindowLongPtr failed" ) );
		return false;
	}
...
bool Win32InputSys::IsInBox ( Vector2 box_pos, Vector2 box_size )
{
	return (
